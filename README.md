...
```mermaid
graph LR
    A[🇫🇷 Vous voulez<br/>passer AZ-305<br/>en francais] --> B{Vous cherchez<br/>quoi ?}
    B -->|Ressources gratuites| C[📚 Cheatsheets<br/>+ schemas]
    B -->|Comprendre l'exam| D[🎯 Domaines<br/>+ patterns]
    B -->|Vocabulaire FR/EN| E[📖 Glossaire]
    B -->|Formation complete| F[🎓 Contact<br/>formateur MCT]
...
```mermaid
pie title Repartition des domaines AZ-305 (poids exam)
    "Domain 4 - Infrastructure" : 32
    "Domain 1 - Identity, Governance, Monitoring" : 27
    "Domain 2 - Data Storage" : 22
    "Domain 3 - Business Continuity" : 17
```
